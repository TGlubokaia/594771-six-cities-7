  ...
  return(
    <Fragment>
      <div style={{display: 'none'}}>
        <svg xmlns="http://www.w3.org/2000/svg"><symbol id="icon-arrow-select" viewBox="0 0 7 4"><path fill-rule="evenodd" clip-rule="evenodd" d="M0 0l3.5 2.813L7 0v1.084L3.5 4 0 1.084V0z"></path></symbol><symbol id="icon-bookmark" B="0 0 17 18"><path d="M3.993 2.185l.017-.092V2c0-.554.449-1 .99-1h10c.522 0 .957.41.997.923l-2.736 14.59-4.814-2.407-.39-.195-.408.153L1.31 16.44 3.993 2.185z"></path></symbol><symbol id="icon-star" B="0 0 13 12"><path fill-rule="evenodd" clip-rule="evenodd" d="M6.5 9.644L10.517 12 9.451 7.56 13 4.573l-4.674-.386L6.5 0 4.673 4.187 0 4.573 3.549 7.56 2.483 12 6.5 9.644z"></path></symbol></svg>
      </div>
            ...
            <div class="property__gallery-container container">
              <div class="property__gallery">
                <div class="property__image-wrapper">
                  <img class="property__image" src="img/room.jpg" alt="Photo studio"></img>
                </div>
                <div class="property__image-wrapper">
                  <img class="property__image" src="img/apartment-01.jpg" alt="Photo studio"></img>
                </div>
                <div class="property__image-wrapper">
                  <img class="property__image" src="img/apartment-02.jpg" alt="Photo studio"></img>
                </div>
                <div class="property__image-wrapper">
                  <img class="property__image" src="img/apartment-03.jpg" alt="Photo studio"></img>
                </div>
                <div class="property__image-wrapper">
                  <img class="property__image" src="img/studio-01.jpg" alt="Photo studio"></img>
                </div>
                <div class="property__image-wrapper">
                  <img class="property__image" src="img/apartment-01.jpg" alt="Photo studio"></img>
                </div>
                ...
                <div class="property__host">
                  ...
                  <div class="property__host-user user">
                    <div class="property__avatar-wrapper property__avatar-wrapper--pro user__avatar-wrapper">
                      <img class="property__avatar user__avatar" src="img/avatar-angelina.jpg" width="74" height="74" alt="Host avatar"></img>
                    </div>
                ...
                <section class="property__reviews reviews">
                    ...
                    <li class="reviews__item">
                      <div class="reviews__user user">
                        <div class="reviews__avatar-wrapper user__avatar-wrapper">
                          <img class="reviews__avatar user__avatar" src="img/avatar-max.jpg" width="54" height="54" alt="Reviews avatar"></img>
                        </div>
                  ...
                  <form class="reviews__form form" action="#" method="post">
                    ...
                    <div class="reviews__rating-form form__rating">
                      <input class="form__rating-input visually-hidden" name="rating" value="5" id="5-stars" type="radio"></input>
                      ...
                      <input class="form__rating-input visually-hidden" name="rating" value="4" id="4-stars" type="radio"></input>
                      ...
                      <input class="form__rating-input visually-hidden" name="rating" value="3" id="3-stars" type="radio"></input>
                      ...
                      <input class="form__rating-input visually-hidden" name="rating" value="2" id="2-stars" type="radio"></input>
                      ...
                      <input class="form__rating-input visually-hidden" name="rating" value="1" id="1-star" type="radio"></input>
